    ...
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                // added to fix issue with sent and recieved code
                ...
                await _emailSender.SendEmailAsync(
                    Input.NewEmail,
                    EmailSubjectConstants.ConfirmEmail,
                    EmailHtmlMessages.ConfirmEmailHtml(HtmlEncoder.Default.Encode(callbackUrl)));
